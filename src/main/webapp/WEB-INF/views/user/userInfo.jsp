                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img headImage" src="${ctx}${userInfo.icon}" id="demo1"
                                         height="110">
...
<script>
    layui.config({
        ...
        var uploadInst = upload.render({
            elem: '#headImg'
            , url: '${ctx}/modify/uploadUserIcon.html'
            , size: 2048 //KB
            , before: function (obj) {
                //预读本地文件示例，不支持ie8
        ...
        $('#send-email-code').click(function () {
            ...
            $.ajax({
                type: "get",
                url: "${ctx}/forget/sendVerifyCodeToEmail.html",
                async: true,
                data: {"email": email},
        ...
        form.on('submit(setmyinfo)', function (obj) {
            ...
            //请求接口
            $.ajax({
                url: '${ctx}/modify/emailCodeTest.html' //实际使用请改成服务端真实接口
                ...
                , success: function (res) {
                    if (res.data == "codeCorrect") {
                        ...
                        $.ajax({
                            ...
                            url: '${ctx}/modify/setUserInfo.html' //实际使用请改成服务端真实接口
