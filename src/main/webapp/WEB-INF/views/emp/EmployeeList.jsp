...
<script src="${ctx}/static/layuiadmin/layui/layui.js" charset="UTF-8"></script>
<script>
    layui.config({
        ...
        table.render({
            elem: '#empInfoQuery'
            , url: '${ctx}/employee/queryAllEmp.html' //向后端默认传page和limit
            , cols: [[
        ...
        $("#query-all-info").click(function () {
            table.reload('empInfoTable', {
                url: '${ctx}/employee/queryAllEmp.html'
                , request: {
                    pageName: 'pageNum',
                    limitName: 'pageSize'  //如不配置，默认为page=1&limit=10
                }
        ...
        $("#query").click(function () {
            ...
            //执行重载
            table.reload('empInfoTable', {
                url: '${ctx}/employee/queryEmpInfo.html' //向后端默认传page和limit
                , where: { //设定异步数据接口的额外参数，任意设
                    empname: empInfo
                }
                , request: {
