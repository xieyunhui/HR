...
<head>
    ...
    <link rel="stylesheet" href="${request}/static/layuiadmin/layui/css/layui.css" media="all">
    <link rel="stylesheet" href="${request}/static/layuiadmin/style/admin.css" media="all">
</head>
<body>
...
<script src="${request}/static/layuiadmin/layui/layui.js" charset="UTF-8"></script>
<script>
    layui.config({
        base: '${request}/static/layuiadmin/' //静态资源所在路径
    }).extend({
